...
export default {
    ...
    var data = {
      ...
      options: {
        ...
        customBackend: {
          ...
          "2333free.vercel.app (自动编译最新版本后端-测试）": "https://2333free.vercel.app/sub?",
        ...
        backendOptions: [
          ...
          { value: "https://2333free.vercel.app/sub?" },
  ...
  mounted() {
    ...
    this.form.customBackend = "https://2333free.vercel.app/sub?";
